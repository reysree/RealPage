...
> **Cursor harness:** Mirrored from `.claude/agents/qa-analyst.md` with paths pointing at `.cursor/skills/` where applicable.
...
5. `.cursor/skills/recall/SKILL.md` — checkpoint protocol you must follow at the end.
...
Once the report is written, run `/recall` to write a checkpoint following `.cursor/skills/recall/SKILL.md`.
