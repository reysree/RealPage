...
1. `.cursor/skills/python-guide/SKILL.md` — Python coding contract
2. `.cursor/skills/openai-sdk-guide/SKILL.md` — Agent/tool coding contract
3. `.cursor/skills/tdd/SKILL.md` — behavior-first test workflow for feature and bug work
...
- For feature and bug work, use `.cursor/skills/tdd/SKILL.md` unless the user explicitly asks to skip tests
...
3. Run `/recall` to write a checkpoint to `logs/` — follow the format in `.cursor/skills/recall/SKILL.md`
